                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="populacao" id="populacao" maxlength="100" placeholder="populacao" value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">area</label>
                                <input type="text" class="form-control" name="area" id="area" required maxlength="100" placeholder="area" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
